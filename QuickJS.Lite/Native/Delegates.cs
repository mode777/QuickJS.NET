...
namespace QuickJS.Native
{
	...
	/* return the module specifier (allocated with js_malloc()) or NULL if
	   exception */
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	public delegate IntPtr JSModuleNormalizeFunc(JSContext ctx, [MarshalAs(UnmanagedType.LPStr)] string module_base_name, [MarshalAs(UnmanagedType.LPStr)] string module_name, IntPtr opaque);
