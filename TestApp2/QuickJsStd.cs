...
namespace TestApp2
{
	internal static class QuickJsStd
	{
		...
		internal static string ValueToString(JSContext ctx, JSValue value){
		...
		internal static JSValue js_print(JSContext ctx, JSValue this_val, int argc, JSValue[] argv){
		...
		internal static unsafe void js_eval_buf(JSContext ctx, byte[] bytes, string filename, JSEvalFlags eval_flags)
		{
