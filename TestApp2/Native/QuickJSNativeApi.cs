...
namespace QuickJS.Native
{
	...
	public static class QuickJSNativeApi
	{
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern void JS_SetMemoryLimit(JSRuntime rt, nint limit);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern void JS_SetGCThreshold(JSRuntime rt, nint gc_threshold);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern void JS_SetMaxStackSize(JSRuntime rt, nint stack_size);
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr js_malloc_rt(JSRuntime rt, nint size);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern void js_free_rt(JSRuntime rt, IntPtr ptr);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr js_realloc_rt(JSRuntime rt, IntPtr ptr, nint size);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern nint js_malloc_usable_size_rt(JSRuntime rt, [In] IntPtr ptr);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr js_mallocz_rt(JSRuntime rt, nint size);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr js_malloc(JSContext ctx, nint size);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern void js_free(JSContext ctx, IntPtr ptr);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr js_realloc(JSContext ctx, IntPtr ptr, nint size);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern nint js_malloc_usable_size(JSContext ctx, [In] IntPtr ptr);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr js_realloc2(JSContext ctx, IntPtr ptr, nint size, out nint pslack);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr js_mallocz(JSContext ctx, nint size);
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr js_strndup(JSContext ctx, [In] IntPtr s, nint n);
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern JSAtom JS_NewAtomLen(JSContext ctx, [In, MarshalAs(UnmanagedType.LPStr)] string str, nint len);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public unsafe static extern JSAtom JS_NewAtomLen(JSContext ctx, byte* str, nint len);
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern JSValue JS_NewStringLen(JSContext ctx, [MarshalAs(UnmanagedType.LPStr)] string s, nint len);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public unsafe static extern JSValue JS_NewStringLen(JSContext ctx, byte* str, nint len);
		...
		/// </remarks>
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr JS_ToCStringLen2(JSContext ctx, out nint len, [In] JSValue val, [MarshalAs(UnmanagedType.Bool)] bool cesu8);
		...
		/// </remarks>
		[MethodImpl(AggressiveInlining)]
		public static IntPtr JS_ToCStringLen(JSContext ctx, out nint len, [In] JSValue val)
		{
		...
		{
			return JS_ToCStringLen2(ctx, out nint len, val, false);
		}
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.Bool)]
		public unsafe static extern bool JS_DetectModule([MarshalAs(UnmanagedType.LPStr)] string input, nint input_len);

		/* 'input' must be zero terminated i.e. input[input_len] = '\0'. */
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public unsafe static extern JSValue JS_Eval(JSContext ctx, byte* input, nint input_len, [MarshalAs(UnmanagedType.LPStr)] string filename, JSEvalFlags eval_flags);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public unsafe static extern JSValue JS_Eval(JSContext ctx, byte* input, nint input_len, byte* filename, JSEvalFlags eval_flags);
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public unsafe static extern JSValue JS_ParseJSON(JSContext ctx, byte* buffer, nint bufferSize, byte* filename);
		...
		/// <returns>The new <see cref="JSValue"/> corresponding to the given JSON text or <see cref="JSValue.Exception"/>.</returns>
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public unsafe static extern JSValue JS_ParseJSON(JSContext ctx, byte* buffer, nint bufferSize, [MarshalAs(UnmanagedType.LPStr)] string filename);
		...
		/// <returns>The new <see cref="JSValue"/> corresponding to the given JSON text or <see cref="JSValue.Exception"/>.</returns>
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern JSValue JS_ParseJSON(JSContext ctx, IntPtr buffer, nint bufferSize, [MarshalAs(UnmanagedType.LPStr)] string filename);
		...
		/// <returns>The new <see cref="JSValue"/> corresponding to the given JSON text or <see cref="JSValue.Exception"/>.</returns>
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern JSValue JS_ParseJSON(JSContext ctx, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] byte[] buffer, nint bufferSize, [MarshalAs(UnmanagedType.LPStr)] string filename);
		...
		/// <returns>The new <see cref="JSValue"/> corresponding to the given JSON text or <see cref="JSValue.Exception"/>.</returns>
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		public static extern JSValue JS_ParseJSON(JSContext ctx, [MarshalAs(UnmanagedType.LPStr)] string json, nint len, [MarshalAs(UnmanagedType.LPStr)] string filename);
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern JSValue JS_NewArrayBuffer(JSContext ctx, IntPtr buffer, nint len, JSFreeArrayBufferDataFunc free_func, IntPtr opaque, [MarshalAs(UnmanagedType.Bool)] bool is_shared);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern JSValue JS_NewArrayBufferCopy(JSContext ctx, IntPtr buffer, nint len);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public unsafe static extern JSValue JS_NewArrayBufferCopy(JSContext ctx, byte* buf, nint len);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern void JS_DetachArrayBuffer(JSContext ctx, [In] JSValue obj);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr JS_GetArrayBuffer(JSContext ctx, out nint size, [In] JSValue obj);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern JSValue JS_GetTypedArrayBuffer(JSContext ctx, [In] JSValue obj, out nint byte_offset, out nint byte_length, out nint bytes_per_element);
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr JS_WriteObject(JSContext ctx, out nint bufferSize, [In] JSValue obj, JSReaderWriterFlags flags);
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern JSValue JS_ReadObject(JSContext ctx, IntPtr buffer, nint bufferSize, JSReaderWriterFlags flags);
		...
		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern JSPromiseState JS_PromiseState(JSContext ctx, JSValue promise);

		[DllImport("quickjs", CallingConvention = CallingConvention.Cdecl)]
		public static extern JSValue JS_PromiseResult(JSContext ctx, JSValue promise);
